...
class UserScoreAggregateTest extends TestCase
{
    ...
    public function testFailedScoresAreAttemptsOnly()
    {
        ...
        $agg->addScore(Score::factory()->failed()->create([
            'room_id' => $this->room,
            'playlist_item_id' => $playlistItem,
            'user_id' => $user,
        ]));

        $agg->addScore(Score::factory()->passed()->create([
            'room_id' => $this->room,
            'playlist_item_id' => $playlistItem,
            'user_id' => $user,
        ]));
    ...
    public function testPassedScoresAreAveraged()
    {
        ...
        $agg = UserScoreAggregate::new($user, $this->room);
        $agg->addScore(Score::factory()->create([
            'room_id' => $this->room,
            'playlist_item_id' => $playlistItem,
            'user_id' => $user,
            'total_score' => 1,
    ...
    {
        return PlaylistItem::factory()->create(['room_id' => $this->room]);
    }
}
