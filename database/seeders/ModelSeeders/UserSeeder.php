...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory()->count(10)->create([
            ...
            $rank2 = rand(1, 500000);
            $rank3 = rand(1, 500000);
            $st = $u->statisticsOsu()->save(UserStatistics\Osu::factory()->make(['country_acronym' => $country_code, 'rank' => $rank0, 'rank_score_index' => $rank0]));
            $st1 = $u->statisticsOsu()->save(UserStatistics\Taiko::factory()->make(['country_acronym' => $country_code, 'rank' => $rank1, 'rank_score_index' => $rank1]));
            $st2 = $u->statisticsOsu()->save(UserStatistics\Fruits::factory()->make(['country_acronym' => $country_code, 'rank' => $rank2, 'rank_score_index' => $rank2]));
            $st3 = $u->statisticsOsu()->save(UserStatistics\Mania::factory()->make(['country_acronym' => $country_code, 'rank' => $rank3, 'rank_score_index' => $rank3]));
            // END USER STATS
